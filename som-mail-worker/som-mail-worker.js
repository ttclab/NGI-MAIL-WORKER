...
function createEmailEventObject(msg) {
  ...
  switch (command) {
    case globals.WORKFLOW_CREATO:
      ...
      emailParams.subject = "Nuovo workflow in attesa";
      emailParams.template = templateDir + "workflowCreato.html";
      break;
    case globals.WORKFLOW_DA_FIRMARE:
      emailParams.service = command;
      emailParams.from = globals.SERVICE_EMAIL;
      emailParams.to = jsonParam.data.mailList;
      emailParams.subject = "Nuovo workflow da firmare";
      emailParams.template = templateDir + "workflowDaFirmare.html";
      break;
    case globals.WORKFLOW_RIFIUTATO:
      emailParams.service = command;
      emailParams.from = globals.SERVICE_EMAIL;
      emailParams.to = jsonParam.data.mailList;
      emailParams.subject = "Workflow rifiutato";
      emailParams.template = templateDir + "workflowRifiutato.html";
      break;
    case globals.WORKFLOW_ACCETTATO:
      emailParams.service = command;
      emailParams.from = globals.SERVICE_EMAIL;
      emailParams.to = jsonParam.data.mailList;
      emailParams.subject = "Workflow approvato";
      emailParams.template = templateDir + "workflowAccettato.html";
      break;
    case globals.POP_ESEGUITO:
      emailParams.service = command;
      emailParams.from = globals.SERVICE_EMAIL;
      emailParams.to = jsonParam.data.mailList;
      emailParams.subject = "Pop eseguito";
      emailParams.template = templateDir + "popEseguito.html";
      break;
  }
...
function displayMsgReceivedFromQueue(msg) {
  console.log("Msg received from SOM queue : " + JSON.stringify(msg.data));
}
